...
/*   Updated: 2024/11/26 16:50:13 by estosche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap:: ClapTrap() : name(), hitPoints(10), energyPoints(10), attackDamage() {
...
void ClapTrap:: attack(const std::string& target) {
	...
	if(hitPoints > 0 && energyPoints > 0){
		energyPoints -= 1;
		std::cout << "ClapeTrap " << name << " attacks " << target << ", causing " 
